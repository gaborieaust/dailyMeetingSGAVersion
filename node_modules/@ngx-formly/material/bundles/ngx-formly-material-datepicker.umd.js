(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@ngx-formly/core'), require('@angular/forms'), require('@angular/core'), require('@ngx-formly/material/form-field'), require('@angular/material/input'), require('@angular/material/datepicker')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/material/datepicker', ['exports', '@angular/common', '@ngx-formly/core', '@angular/forms', '@angular/core', '@ngx-formly/material/form-field', '@angular/material/input', '@angular/material/datepicker'], factory) :
    (factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].material = global['ngx-formly'].material || {}, global['ngx-formly'].material.datepicker = {}),global.ng.common,global.core,global.ng.forms,global.ng.core,global['ngx-formly'].material['form-field'],global.ng.material.input,global.ng.material.datepicker));
}(this, (function (exports,common,core,forms,core$1,formField,input,datepicker) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormlyDatepickerTypeComponent = /** @class */ (function (_super) {
        ...
        FormlyDatepickerTypeComponent.propDecorators = {
            ...
            datepickerInput: [{ type: core$1.ViewChild, args: [datepicker.MatDatepickerInput, ( /** @type {?} */({ static: true })),] }],
            datepickerToggle: [{ type: core$1.ViewChild, args: ['datepickerToggle',] }]
        };
