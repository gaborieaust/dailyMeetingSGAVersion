    ...
    ***************************************************************************** */
    ...
    function registerControl(field, control, emitEvent) {
        ...
        var _loop_1 = function (i) {
            ...
            if (!parent.get([path])) {
                 ...
                 * @return {?}
                 */function () { return parent.setControl(path, new forms.FormGroup({})); }));
            }
    ...
    var FieldArrayType = /** @class */ (function (_super) {
         ...
         */
            function (field) {
                if (!field.formControl && field.key) {
                    ...
                    registerControl(field, control ? control : new forms.FormArray([], { updateOn: field.modelOptions.updateOn }));
                }
        ...
        FieldArrayType.decorators = [
            { type: i0.Directive, args: [{ selector: '[ɵfieldArray]' },] }
        ];
        /** @nocollapse */
                ...
                for (var key in expressionProperties) {
                    ...
                    if (ignoreCache || (expressionProperties[key].expressionValue !== expressionValue
                        && (!isObject(expressionValue)
                            || rxjs.isObservable(expressionValue)
                     ...
                     */function (f) { return !!f._hide; })))) {
                        ...
                        if (resetOnHide && field.resetOnHide) {
                            ...
                            if (field.fieldGroup) {
                                ...
                                if (field.formControl instanceof forms.FormArray) {
