(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@ngx-formly/core'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/core/json-schema', ['exports', '@angular/core', '@angular/forms', '@ngx-formly/core', 'rxjs/operators'], factory) :
    (factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].core = global['ngx-formly'].core || {}, global['ngx-formly'].core['json-schema'] = {}),global.ng.core,global.ng.forms,global['ngx-formly'].core,global.rxjs.operators));
}(this, (function (exports,i0,forms,core,operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function totalMatchedFields(field) {
        if (!field.fieldGroup) {
            return field.key && core.ɵgetFieldInitialValue(field) !== undefined ? 1 : 0;
        }
                    ...
                    fieldGroup: [
                        {
                            ...
                            hooks: {
                                 ...
                                 * @return {?}
                                 */function (f) {
                                    return f.formControl.valueChanges.pipe(operators.tap(( /**
                                     * @return {?}
                        ...
                        },
                        {
                             ...
                             * @return {?}
                             */function (s, i) {
                                return (__assign({}, _this_1._toFieldConfig(s, __assign({}, options, { resetOnHide: true })), { hideExpression: ( /**
                                         * @param {?} m
                                         * @param {?} fs
                                         * @param {?} f
                                         * @return {?}
         ...
         */
            function (field, schema, options) {
                var form = (( /** @type {?} */(field.options)))._buildField({
                    ...
                    model: field.model ? core.ɵclone(field.model) : (field.fieldArray ? [] : {}),
                }).form;
                return form.valid;
            };
        /**
